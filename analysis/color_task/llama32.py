...
# Load data
df = pd.read_csv('../../data/model_output/logit_lens/colors_Llama-3.2-3B-Instruct.csv')

print("\nColors Task - Llama-3.2-3B-Instruct (3B parameters, 28 layers)")
print()
...
print(f"  Layer 7:  {layer_acc[7]:.1f}%")
print(f"  Layer 14: {layer_acc[14]:.1f}%")
print(f"  Layer 21: {layer_acc[21]:.1f}%")
print(f"  Layer 27: {layer_acc[27]:.1f}%")
print(f"  Gain:     {layer_acc[27] - layer_acc[0]:.1f} pp")
print()
