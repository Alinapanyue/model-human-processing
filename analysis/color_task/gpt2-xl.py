...
# Load data
df = pd.read_csv('../../data/model_output/logit_lens/colors_gpt2-xl.csv')

print("\nColors Task - GPT-2-XL (1.5B parameters, 48 layers)")
print()
...
print(f"  Layer 12: {layer_acc[12]:.1f}%")
print(f"  Layer 24: {layer_acc[24]:.1f}%")
print(f"  Layer 36: {layer_acc[36]:.1f}%")
print(f"  Layer 47: {layer_acc[47]:.1f}%")
print(f"  Gain:     {layer_acc[47] - layer_acc[0]:.1f} pp")
print()
