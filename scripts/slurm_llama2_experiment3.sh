#!/bin/bash
#SBATCH --job-name=llama2_exp3
#SBATCH --output=logs/llama2_exp3_%A_%a.out
#SBATCH --error=logs/llama2_exp3_%A_%a.err
...
# Run Llama-2 models for Experiment 3 (补充运行)
# Only runs Llama-2-7b-hf and Llama-2-13b-hf

echo "=========================================="
echo "Colors Task - Experiment 3 (Llama-2 补充)"
